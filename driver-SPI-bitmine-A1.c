...
/*
		switch(cgpu->device_id){
			...
			case 2:A1_SetA1PLLClock(chain[i], A1Pll3);break;
			case 3:A1_SetA1PLLClock(chain[i], A1Pll4);break;
			case 4:A1_SetA1PLLClock(chain[i], A1Pll5);break;
			case 5:A1_SetA1PLLClock(chain[i], A1Pll6);break;
			default:;
		}

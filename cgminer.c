...
static void curses_print_status(void)
{
	...
	cg_mvwprintw(statuswin, 0, 0, " " PACKAGE " version " BOS_SMALL_VERSION_STRING " - Started: %s", datestamp);
...
# ifdef __linux
	...
	snprintf(packagename, sizeof(packagename), "%s %s", PACKAGE, BOS_SMALL_VERSION_STRING);
